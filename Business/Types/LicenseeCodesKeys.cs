...
{
    internal static class LicenseeCodesKeys
    {
        ...
        public static Dictionary<Decimal, string> Values
        {
            get
            {
                if (LicenseeCodesKeys._values is null)
                    LicenseeCodesKeys._values = new Dictionary<Decimal, string>
                    {
                        { 0x00, "None" },
                        { 0x01, "Nintendo" },
                        { 0x08, "Capcom" },
                ...
                return LicenseeCodesKeys._values;
            }
        }
    }
}
